...
class _$EventEntityCopyWithImpl<$Res, $Val extends EventEntity>
  ...
  $Res call({
    ...
    Object? minimumAge = freezed,
    Object? price = freezed,
    Object? organizatorId = freezed,
...
class _$EventEntityImpl implements _EventEntity {
  ...
  @override
  String toString() {
    return 'EventEntity(id: $id, placeId: $placeId, categoryId: $categoryId, minimumAge: $minimumAge, price: $price, organizatorId: $organizatorId, photo: $photo, name: $name, description: $description, dateStart: $dateStart)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.organizatorId, organizatorId) ||
                other.organizatorId == organizatorId) &&
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, placeId, categoryId,
      minimumAge, price, organizatorId, photo, name, description, dateStart);
...
abstract class _EventEntity implements EventEntity {
  const factory _EventEntity(
      ...
      final String name,
      final String description,
      final DateTime? dateStart}) = _$EventEntityImpl;
