...
mixin _$MapState {
  ...
  List<MarkerEntity> get markerList => throw _privateConstructorUsedError;
...
class __$$PostStateImplCopyWithImpl<$Res>
    extends _$MapStateCopyWithImpl<$Res, _$PostStateImpl>
...
class _$PostStateImpl implements _PostState {
  const _$PostStateImpl(
      ...
      final List<MarkerEntity> markerList = const [],
      this.latitude = 0,
      this.longitude = 0})
  ...
  final List<MarkerEntity> _markerList;
  @override
  @JsonKey()
  List<MarkerEntity> get markerList {
    if (_markerList is EqualUnmodifiableListView) return _markerList;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableListView(_markerList);
  }
  ...
  @override
  String toString() {
    return 'MapState(asyncSnapshot: $asyncSnapshot, markerList: $markerList, latitude: $latitude, longitude: $longitude)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, asyncSnapshot,
      const DeepCollectionEquality().hash(_markerList), latitude, longitude);
